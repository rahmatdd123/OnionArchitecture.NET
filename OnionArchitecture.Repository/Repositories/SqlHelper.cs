...
namespace OnionArchitecture.Repository.Repositories
{
    public static class SqlHelper
    {
        ...
        static SqlHelper()
        {
            if (ConfigurationManager.ConnectionStrings[CONNECTION_STRING_NAME] != null)
            {
                mDefaultConnStr = ConfigurationManager.ConnectionStrings[CONNECTION_STRING_NAME].ConnectionString;
            }
        }
